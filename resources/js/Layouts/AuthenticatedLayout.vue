...
const page = usePage();
const isTeamAdmin = computed(() => (page.props.auth as any)?.isTeamAdmin ?? false);
</script>
                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            >
                                ...
                                <NavLink
                                    :href="route('projects.shared')"
                                    :active="route().current('projects.shared')"
                                >
                                    Shared
                                </NavLink>
                                <NavLink
                                ...
                                <NavLink
                                    v-if="isTeamAdmin"
                                    :href="route('settings.mail-test')"
                                    :active="route().current('settings.mail*')"
                                >
                                    Mail
                                </NavLink>
                                <NavLink
                                    :href="route('settings.api-tokens')"
                                    :active="route().current('settings.api*')"
                                >
                                    API Tokens
                                </NavLink>
                                <NavLink
